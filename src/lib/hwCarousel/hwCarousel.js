...
* @Last Modified time: 2017-11-09 11:19:18
*/
        ...
        return $(this).each(function(){            
            ...
            var Cart = {
                 init(){
                        ...
                        this.lastIndex = 0;
                        // 根据参数的img数量生成li和img;
                        this.imgEle.innerHTML = opt.imgList.map(function(item){
                        ...
                        if(opt.pages){
                            ...
                            this.pageEle.innerHTML = opt.imgList.map(item=>{
                                return `<li></li>`;
                            }).join('');
                    ...
                    move(){
                        ...
                        if(opt.direction === 'horizontal'){
                            this.imgEle.style.width = this.allImg.length * opt.width + 'px';
